                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php
                                $qry = mysqli_query($koneksi, "SELECT SUM(jumlah) as jumlah FROM tabel_rinci_pembelian WHERE tabel_rinci_pembelian.kd_barang = '$d[kd_barang]'");
                                $e = mysqli_fetch_array($qry);
                                $jml_beli = $e['jumlah'];
                                ?>
                                <?php echo $jml_beli; ?>
                            </td>
                            ...
                            <td>
                                <?php
                                $qry = mysqli_query($koneksi, "SELECT SUM(jumlah) as jumlah FROM tabel_rinci_penjualan WHERE tabel_rinci_penjualan.kd_barang = '$d[kd_barang]'");
                            ...
                            <td>
                                <?php
                                $qry = mysqli_query($koneksi, "SELECT SUM(jumlah) as jumlah FROM tabel_rinci_retur WHERE tabel_rinci_retur.kd_barang = '$d[kd_barang]'");
                                $g = mysqli_fetch_array($qry);
                                $jml_retur = $g['jumlah'];
                                ?>
                            ...
                            <?
$stok_akhir = $d['stok'];
$stok_awal = ($stok_akhir+$jml_jual+$jml_beli)-$jml_retur;
?>
