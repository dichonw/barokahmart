...
$total_item		=$jml+$total_item;
 ...
 <?php 
    ...
    elseif(empty($alamat_awal) || empty($alamat_akhir)){?>
      <tr>
        <td>Alamat : <br /><?php echo $alamat_awal; ?>
      </tr>
    <tr><td colspan="2"><hr /></td></tr>
    <?php }
    else{?>
      <tr>
        <td>Kurir (Alamat)<br />Alamat Awal : <br /><?php echo $alamat_awal; ?><br />
        <td><br />Alamat Akhir : <br /><?php echo $alamat_akhir; ?>
      </tr>
