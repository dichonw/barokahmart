...
function popup(){
window.open('faktur_retur_pelanggan.php?no_faktur=<?php echo $_GET['no_faktur'];?>','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes');}
</script>
          ...
          <div class="product-details">
            ...
            <div class="product-right">
              <div class="product-description">               	
                <ul class="ds-btn">
                	 <li><a class="btn btn-lg btn-default" href="kasir.php?menu=retur">
                     ...
                     <li><a class="btn btn-lg btn-danger" href="#" onClick="popup()">
                      <i class="fa fa-file-text fa-2x pull-left"></i><span>NOTA<br><small>Penjualan Retur</small>
                      </span></a>                         
                    </li>
