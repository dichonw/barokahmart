...
function popup(){
window.open('faktur_retur_supplier.php?no_faktur=<?php echo $_GET['no_faktur'];?>','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes');}
</script>
          ...
          <div class="product-details">
            <div class="product-left">
              <div class="product-info">
                ...
                <div class="product-title">
                  <p>Silahkan mencetak <br><b>NOTA RETUR</b></p>
                </div>                
              </div>
            ...
            <div class="product-right">
              <div class="product-description">               	
                <ul class="ds-btn">
                	 <li><a class="btn btn-lg btn-default" href="retur.php?menu=retur_supplier">
                      <i class="fa fa-calculator fa-2x pull-left"></i><span>KEMBALI<br><small>Halaman Retur</small>
                      </span></a>                         
                    </li>
                     <li><a class="btn btn-lg btn-danger" href="#" onClick="popup()">
                      <i class="fa fa-file-text fa-2x pull-left"></i><span>NOTA<br><small>Pembelian Retur</small>
                      </span></a>                         
                    </li>
