...
<body onload="print()">
  <table width="200" border="0">
    <tr>
      <td colspan="2"><?php echo $nama_toko; ?><br /><?php echo $alamat; ?><br /><?php echo $tlp_toko; ?></td>
    </tr>
    ...
    <tr>
      <td colspan="2">NOTA.<?php echo $no_faktur; ?><br /><?php echo date('d-m-y | H:i:s'); ?>
        <br /><?php echo $nama; ?>/<?php echo $id; ?></td>
    </tr>
    <tr>
      <td colspan="2">
        <hr />
    ...
    <?php }
    $kembali = $cash_grosir - $total_bayar; ?>
    <tr>
      <td colspan="2">
        <hr />
      </td>
    ...
    <tr>
      <td>TTL.<br /><?php echo $total_item; ?> pcs</td>
    ...
    <tr>
      <td colspan="2"><a href="../?menu=grosir">TERIMA KASIH<br />ATAS KUNJUNGAN ANDA</a></td>
    </tr>
