...
while ($rinci_pembelian = mysqli_fetch_array($get_rinci_pembelian)) {
    ...
    if ($hitung_record_stok > 0) {
        ...
        /*$query_insert_stok1="INSERT INTO tabel_stok_toko (kd_toko,kd_barang,stok) VALUES ('".$kd_toko."','".$kd_barang."','".$jml."')";
$query_insert_stok2="INSERT INTO tabel_stok_toko (kd_toko,kd_barang,stok) VALUES ('MM002','".$kd_barang."','0')";
$query_insert_stok3="INSERT INTO tabel_stok_toko (kd_toko,kd_barang,stok) VALUES ('MM003','".$kd_barang."','0')";
$query_insert_stok4="INSERT INTO tabel_stok_toko (kd_toko,kd_barang,stok) VALUES ('MM004','".$kd_barang."','0')";
$insert_stok1=mysql_query($query_insert_stok1);
$insert_stok2=mysql_query($query_insert_stok2);
$insert_stok3=mysql_query($query_insert_stok3);
$insert_stok4=mysql_query($query_insert_stok4);
} }
if($update_stok||$insert_stok1||$insert_stok2||$insert_stok3||$insert_stok4){
