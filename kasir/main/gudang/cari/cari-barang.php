...
<ul class="nav nav-text">
	...
	$q = $_POST['q'];
	$produk = mysqli_query($koneksi, "SELECT 
				...
				FROM tabel_barang JOIN tabel_stok_toko ON tabel_stok_toko.kd_barang = tabel_barang.kd_barang WHERE nm_barang LIKE '%" . $q . "%'");
		...
		<li>
			...
			<div class="col-sm-9">
				...
				<p><i class="fa fa-caret-right"></i>
					<?php echo $a['nm_barang']; ?>/<?php echo $a['merek']; ?>/<?php echo $a['jenis']; ?>/<?php echo $a['tipe']; ?>/<?php echo $a['model']; ?></p>
