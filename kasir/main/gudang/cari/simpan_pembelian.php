...
window.alert('Proses penyimpanan gagal silahkan isi data kembali');javascript:history.back();</script>";
    ...
    if ($insert_pembelian) {
        echo "<script type='text/javascript'> alert('Transaksi Berhasil,Menampilkan Nota Pembelian!'); document.location.href='update_stok.php?no_faktur=" . $no_faktur . "';</script>";
    } else {
        echo "<script type='text/javascript'> alert('Transaksi Gagal, Silahkan Ulangi!'); document.location.href='gudang.php?menu=pembelian'; </script> ";
    }
}
