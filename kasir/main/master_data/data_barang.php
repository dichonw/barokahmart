...
$query_data_toko = "SELECT * FROM tabel_toko ORDER BY kd_toko ASC";
$ambil_satuan = mysqli_query($koneksi, $query_data_satuan);
$ambil_kategori = mysqli_query($koneksi, $query_data_kategori);
$ambil_toko = mysqli_query($koneksi, $query_data_toko);
  ...
  <div class="col-sm-6 col-12">
    ...
    <div class="form-group">
      <div class="input-group">
        ...
        <input type="text" name="kd_barang" id="kd_barang" class="form-control" autofocus="autofocus" onchange="proses()" placeholder="Masukkan barcode barang" />
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6 col-12">
    ...
    <div class="input-group">
      ...
      <div class="form-group">
        <div class="input-group">
          <div class="input-group-prepend">
            <div class="input-group-text">Di Toko</div>
          </div>
          <select name="kd_toko" class="form-control" required="required">
          <option disabled selected>Pilih Toko</option>
            <?php
            $ambil_toko_update = mysqli_query($koneksi, $query_data_toko);
            while ($toko_update = mysqli_fetch_array($ambil_toko_update)) {
              $kd_toko_update = $toko_update['kd_toko'];
              $nm_toko_update = $toko_update['nm_toko'];
              $almt_toko_update = $toko_update['almt_toko'];
              echo "<option value=" . $kd_toko_update . ">" . $nm_toko_update . " || " . $almt_toko_update . "</option>";
            }
            ?>
          </select>
        </div>
