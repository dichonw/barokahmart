...
$query="INSERT INTO tabel_penjualan (no_faktur_penjualan,tgl_penjualan,id_user,dp,sisa,ket,status)VALUES('".$no_faktur."',NOW(),'$id_user','','wait','PU Jelantah $ket','$status')";
