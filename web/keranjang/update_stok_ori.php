...
$query="INSERT INTO tabel_penjualan (no_faktur_penjualan,tgl_penjualan,id_user,total_penjualan,dp,sisa,ket,status)VALUES('".$no_faktur."','".$tgl_penjualan."','$id_user','".$total_belanja."','','wait','ONLINE $ket','$status')";
...
echo "<script>document.location.href='keranjang/cek_beli.php?no_faktur=$no_faktur';</script>";
?>