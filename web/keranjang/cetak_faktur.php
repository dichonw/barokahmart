...
function popup1(){
window.open('faktur_penjualan.php?no_faktur=<?php echo $_GET['no_faktur'];?>','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes');}
function popup2(){
window.open('surat_jalan.php?no_faktur=<?php echo $_GET['no_faktur'];?>','page','toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=600,left=50,top=50,titlebar=yes');}
</script>
            ...
            <div class="product-left">
              <div class="product-info">
                ...
                <div class="product-title">
                  <p>Silahkan mencetak <br><b>NOTA PENJUALAN</b> dan <b>SURAT JALAN</b></p>
                </div>                
              </div>
            ...
            <div class="product-right">
              <div class="product-description">               	
                <ul class="ds-btn">
                     ...
                     <li><a class="btn btn-lg btn-danger" href="#" onClick="popup1()">
                      <i class="fa fa-file-text fa-2x pull-left"></i><span>NOTA<br><small>Penjualan Kasir</small>
                      </span></a>                         
                    </li>
                    <li><a class="btn btn-lg btn-primary" href="#" onClick="popup2()">
                      <i class="fa fa-truck fa-2x pull-left"></i><span>SURAT JALAN<br><small>Pengiriman</small>
                      </span></a>                         
                    </li>
                 </ul>   
              </div> 
