...
$sql="select * from tabel_member Where hp='$_GET[hp]'"; 
    ...
    <div class="login-box">
      <div class="login-snip"> 
        <input id="tab-1" type="radio" name="tab" class="sign-in text-center" checked><label for="tab-1" class="tab">
             <strong>Pendaftaran berhasil</strong></label> 
        <input id="tab-2" type="hidden" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
        <div class="login-space">
          <div class="login">
            <small class="text-uppercase text-center">silahkan kirim konfirmasi</small>
           <hr> 
            	<div class="group"><input type="submit" class="button" value="Kirim konfirmasi" onclick='window.location.href="https://wa.me/6281216721163?text=Saya%20sudah%20melakukan%20pendaftaran"'></div>             
         </div>
